...
export function useSlashCommandMenu({
  ...
  const slashCommands = useMemo<SlashCommandItem[]>(() => [
    ...
    { id: 'variable', label: 'Variable', detail: 'Resolved from front matter or linked JSON/CSV data', markdown: '{{ variable_name }}', preview: 'variable' },
    { id: 'citation', label: 'Citation', detail: 'Pandoc citation key', markdown: '[@citation-key]', preview: 'citation' },
    { id: 'image', label: 'Image', detail: 'Copy image into assets and insert Markdown', markdown: '', preview: 'figure' },
  ...
  }, [currentColumn, currentLine, markdown, mode]);
