    ...
    return (
      <main className="app-error-screen">
        <section>
          ...
          <p>
            The editor hit an unexpected error. Your saved files are still on disk. You can return to the visual editor or reload the webview.
          </p>
          <pre>{this.state.error.message}</pre>
          <div className="app-error-actions">
            {canReturnToApp ? <button type="button" onClick={this.reset}>Return to visual editor</button> : null}
